...
describe('calcularPrestacoes', () => {
  ...
  // TPM4
  test('TPM4: montante igual que zero deve retornar array vazia', () => {
    // Give
    const montante = 0;

    // When
    const prestacoes = calculaValor.calcularPrestacoes(montante, 3);

    // Then
    expect(prestacoes.length).toBe(0);
  });

  test('TPM4: montante menor que zero deve retornar array vazia', () => {
    // Give
    const montante = -1;
  ...
  test('TPM4: parcelas igual que zero deve retornar array vazia', () => {
    // Give
  ...
  test('TPM4: parcelas menor que zero deve retornar array vazia', () => {
    // Give
    const numeroPrestacoes = -1;
